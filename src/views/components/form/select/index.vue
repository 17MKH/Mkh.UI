<template>
  <mu-container>
    <mu-doc-component-doc title="下拉框组件(mu-select)" :props="props">
      <mu-doc-demo-block title="简单用法" :meta="code">
        <template #desc>
          ...
          <p>为了方便使用，在<code>el-select</code>基础上封装了<code>mu-select</code>组件，开发人员只需要提供获取下拉数据的方法绑定到action属性，组件会自动调用方法并渲染</p>

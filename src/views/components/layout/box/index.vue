<template>
  <m-container>
    <m-doc-component-doc title="盒子组件(m-box)" :props="props" :events="events" :methods="methods" :slots="slots">
      ...
      <m-doc-demo-block title="底部功能栏" :meta="code4">
        <template #desc>
      ...
      <m-doc-demo-block title="加载动画" :meta="code5">
        <template #desc>
      ...
      <m-doc-demo-block title="内容自适应" :meta="code6">
        <template #desc>
      ...
      <m-doc-demo-block title="盒子布局" :meta="code7">
        <template #desc>
          <p>
            很多人应该都做过下面这种类似的仪表盘或者面板，对于这种页面布局，您可以通过<code>el-row</code>组件来实现，同时为了能够让同一行的盒子组件高度一致，需要在<code>el-row</code>组件上添加一个<code>class="m-box-row"</code>，这样盒子高度会自动填充100%
          </p>
        </template>
        <demo-7></demo-7>
      </m-doc-demo-block>
